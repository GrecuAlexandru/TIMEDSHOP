function productDetails(type)
{
    ...
    switch(type)
    {
        case "cruiser":
            ...
            criteriaUL.appendChild(criteriaLI);
            criteriaLI = document.createElement("li");
            criteriaLI.innerText="Round drawcords in matching body colour with metal tipping";
            criteriaUL.appendChild(criteriaLI);
            criteriaLI = document.createElement("li");
            ...
            criteriaUL.appendChild(criteriaLI);
            criteriaLI = document.createElement("li");
            criteriaLI.innerText="Single needle topstitch at neckline and along hood opening";
            criteriaUL.appendChild(criteriaLI);
            criteriaLI = document.createElement("li");
            criteriaLI.innerText="1x1 rib at sleeve hem and bottom hem";
            criteriaUL.appendChild(criteriaLI);
            criteriaLI = document.createElement("li");
            criteriaLI.innerText="Armhole, sleeve hem and bottom hem with twin needle topstitch";
            criteriaUL.appendChild(criteriaLI);
            criteriaLI = document.createElement("li");
            ...
            madeOf.innerText = "85% ORGANIC RING-SPUN COMBED COTTON, 15% RECYCLED POLYESTER";
            break;
    }
}